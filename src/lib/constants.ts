 ...
 */
export const APP_NAME: string = 'Lunava';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Farcaster Profile Card Generator';
 ...
 */
export const APP_TAGS: string[] = ['fun', 'games', 'socials', 'followers', 'engagement'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Launch Lunava';
